...
def should_aggregate_values(
...
) -> Literal["aggregate_new_values", "__end__"]:
    """Route to test-mode value aggregation or end the run.
    ...
    and emits the delta summary. In ``train`` mode the run is complete once
